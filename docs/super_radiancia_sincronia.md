...
La nota presenta conceptos clave sobre super-radiancia cuántica (Estado de Dicke) y su aplicación en un sistema "Sentinel". Se destacan los siguientes puntos:
